$(document).ready(function () {
    ...
    const icons = [
        ...
        'mdi mdi-account-card',
        'mdi mdi-account-card-outline',
        ...
        'mdi mdi-account-credit-card',
        'mdi mdi-account-credit-card-outline',
        ...
        'mdi mdi-account-network-off',
        'mdi mdi-account-network-off-outline',
        ...
        'mdi mdi-account-school-outline',
        ...
        'mdi mdi-assistant',
        'mdi mdi-asterisk',
        'mdi mdi-asterisk-circle-outline',
        'mdi mdi-at',
        'mdi mdi-atlassian',
        'mdi mdi-atm',
        'mdi mdi-atom',
        ...
        'mdi mdi-attachment',
        'mdi mdi-attachment-check',
        'mdi mdi-attachment-lock',
        'mdi mdi-attachment-minus',
        'mdi mdi-attachment-off',
        'mdi mdi-attachment-plus',
        'mdi mdi-attachment-remove',
        'mdi mdi-atv',
        ...
        'mdi mdi-auto-upload',
        'mdi mdi-autorenew',
        'mdi mdi-autorenew-off',
        'mdi mdi-av-timer',
        'mdi mdi-awning',
        'mdi mdi-awning-outline',
        'mdi mdi-aws',
        'mdi mdi-axe',
        'mdi mdi-axe-battle',
        'mdi mdi-axis',
        ...
        'mdi mdi-bag-personal-tag',
        'mdi mdi-bag-personal-tag-outline',
        ...
        'mdi mdi-battery-clock',
        'mdi mdi-battery-clock-outline',
        ...
        'mdi mdi-blinds',
        'mdi mdi-blinds-horizontal',
        'mdi mdi-blinds-horizontal-closed',
        'mdi mdi-blinds-open',
        'mdi mdi-blinds-vertical',
        'mdi mdi-blinds-vertical-closed',
        ...
        'mdi mdi-briefcase-arrow-left-right',
        'mdi mdi-briefcase-arrow-left-right-outline',
        'mdi mdi-briefcase-arrow-up-down',
        'mdi mdi-briefcase-arrow-up-down-outline',
        ...
        'mdi mdi-bug-outline',
        'mdi mdi-bug-pause',
        'mdi mdi-bug-pause-outline',
        'mdi mdi-bug-play',
        'mdi mdi-bug-play-outline',
        'mdi mdi-bug-stop',
        'mdi mdi-bug-stop-outline',
        'mdi mdi-bugle',
        'mdi mdi-bulkhead-light',
        'mdi mdi-bulldozer',
        'mdi mdi-bulconst',
        'mdi mdi-bulconstin-board',
        'mdi mdi-bullhorn',
        ...
        'mdi mdi-button-cursor',
        'mdi mdi-button-pointer',
        ...
        'mdi mdi-calendar-alert-outline',
        'mdi mdi-calendar-arrow-left',
        'mdi mdi-calendar-arrow-right',
        'mdi mdi-calendar-badge',
        'mdi mdi-calendar-badge-outline',
        ...
        'mdi mdi-calendar-collapse-horizontal-outline',
        'mdi mdi-calendar-cursor',
        'mdi mdi-calendar-cursor-outline',
        'mdi mdi-calendar-edit',
        'mdi mdi-calendar-edit-outline',
        'mdi mdi-calendar-end',
        'mdi mdi-calendar-end-outline',
        'mdi mdi-calendar-expand-horizontal',
        'mdi mdi-calendar-expand-horizontal-outline',
        'mdi mdi-calendar-export',
        'mdi mdi-calendar-export-outline',
        'mdi mdi-calendar-filter',
        'mdi mdi-calendar-filter-outline',
        'mdi mdi-calendar-heart',
        'mdi mdi-calendar-heart-outline',
        'mdi mdi-calendar-import',
        'mdi mdi-calendar-import-outline',
        'mdi mdi-calendar-lock',
        'mdi mdi-calendar-lock-open',
        'mdi mdi-calendar-lock-open-outline',
        'mdi mdi-calendar-lock-outline',
        'mdi mdi-calendar-minus',
        'mdi mdi-calendar-minus-outline',
        ...
        'mdi mdi-calendar-multiselect-outline',
        'mdi mdi-calendar-outline',
        'mdi mdi-calendar-plus',
        'mdi mdi-calendar-plus-outline',
        'mdi mdi-calendar-question',
        'mdi mdi-calendar-question-outline',
        ...
        'mdi mdi-calendar-search-outline',
        'mdi mdi-calendar-star',
        'mdi mdi-calendar-star-outline',
        'mdi mdi-calendar-start',
        'mdi mdi-calendar-start-outline',
        ...
        'mdi mdi-calendar-today-outline',
        'mdi mdi-calendar-week',
        'mdi mdi-calendar-week-begin',
        'mdi mdi-calendar-week-begin-outline',
        'mdi mdi-calendar-week-outline',
        ...
        'mdi mdi-camera-iris',
        'mdi mdi-camera-lock',
        'mdi mdi-camera-lock-open',
        'mdi mdi-camera-lock-open-outline',
        'mdi mdi-camera-lock-outline',
        ...
        'mdi mdi-card-bulconsted',
        'mdi mdi-card-bulconsted-off',
        'mdi mdi-card-bulconsted-off-outline',
        'mdi mdi-card-bulconsted-outline',
        'mdi mdi-card-bulconsted-settings',
        'mdi mdi-card-bulconsted-settings-outline',
        'mdi mdi-card-minus',
        ...
        'mdi mdi-cellphone-arrow-down-variant',
        ...
        'mdi mdi-checkbox-intermediate-variant',
        ...
        'mdi mdi-cloud',
        'mdi mdi-cloud-alert',
        'mdi mdi-cloud-alert-outline',
        'mdi mdi-cloud-arrow-down',
        'mdi mdi-cloud-arrow-down-outline',
        'mdi mdi-cloud-arrow-left',
        'mdi mdi-cloud-arrow-left-outline',
        'mdi mdi-cloud-arrow-right',
        'mdi mdi-cloud-arrow-right-outline',
        'mdi mdi-cloud-arrow-up',
        'mdi mdi-cloud-arrow-up-outline',
        'mdi mdi-cloud-braces',
        'mdi mdi-cloud-cancel',
        'mdi mdi-cloud-cancel-outline',
        'mdi mdi-cloud-check',
        'mdi mdi-cloud-check-outline',
        'mdi mdi-cloud-check-variant',
        'mdi mdi-cloud-check-variant-outline',
        'mdi mdi-cloud-circle',
        'mdi mdi-cloud-circle-outline',
        'mdi mdi-cloud-clock',
        'mdi mdi-cloud-clock-outline',
        'mdi mdi-cloud-cog',
        'mdi mdi-cloud-cog-outline',
        'mdi mdi-cloud-download',
        'mdi mdi-cloud-download-outline',
        'mdi mdi-cloud-lock',
        'mdi mdi-cloud-lock-open',
        'mdi mdi-cloud-lock-open-outline',
        'mdi mdi-cloud-lock-outline',
        'mdi mdi-cloud-minus',
        'mdi mdi-cloud-minus-outline',
        'mdi mdi-cloud-off',
        'mdi mdi-cloud-off-outline',
        'mdi mdi-cloud-outline',
        'mdi mdi-cloud-percent',
        'mdi mdi-cloud-percent-outline',
        'mdi mdi-cloud-plus',
        'mdi mdi-cloud-plus-outline',
        'mdi mdi-cloud-print',
        'mdi mdi-cloud-print-outline',
        'mdi mdi-cloud-question',
        'mdi mdi-cloud-question-outline',
        'mdi mdi-cloud-refresh',
        'mdi mdi-cloud-refresh-outline',
        'mdi mdi-cloud-refresh-variant',
        'mdi mdi-cloud-refresh-variant-outline',
        'mdi mdi-cloud-remove',
        'mdi mdi-cloud-remove-outline',
        ...
        'mdi mdi-content-save-minus',
        'mdi mdi-content-save-minus-outline',
        ...
        'mdi mdi-content-save-plus',
        'mdi mdi-content-save-plus-outline',
        ...
        'mdi mdi-controller-off',
        'mdi mdi-cookie',
        'mdi mdi-cookie-alert',
        'mdi mdi-cookie-alert-outline',
        ...
        'mdi mdi-currency-thb',
        'mdi mdi-currency-try',
        'mdi mdi-currency-twd',
        'mdi mdi-currency-uah',
        ...
        'mdi mdi-database-alert-outline',
        ...
        'mdi mdi-deconste',
        'mdi mdi-deconste-alert',
        'mdi mdi-deconste-alert-outline',
        'mdi mdi-deconste-circle',
        'mdi mdi-deconste-circle-outline',
        'mdi mdi-deconste-clock',
        'mdi mdi-deconste-clock-outline',
        'mdi mdi-deconste-empty',
        'mdi mdi-deconste-empty-outline',
        'mdi mdi-deconste-forever',
        'mdi mdi-deconste-forever-outline',
        'mdi mdi-deconste-off',
        'mdi mdi-deconste-off-outline',
        'mdi mdi-deconste-outline',
        'mdi mdi-deconste-restore',
        'mdi mdi-deconste-sweep',
        'mdi mdi-deconste-sweep-outline',
        'mdi mdi-deconste-variant',
        'mdi mdi-delta',
        'mdi mdi-desk',
        'mdi mdi-desk-lamp',
        'mdi mdi-desk-lamp-off',
        ...
        'mdi mdi-eight-track',
        'mdi mdi-eject',
        'mdi mdi-eject-circle',
        'mdi mdi-eject-circle-outline',
        ...
        'mdi mdi-email-arrow-left',
        'mdi mdi-email-arrow-left-outline',
        'mdi mdi-email-arrow-right',
        'mdi mdi-email-arrow-right-outline',
        'mdi mdi-email-box',
        'mdi mdi-email-check',
        ...
        'mdi mdi-eye-lock',
        'mdi mdi-eye-lock-open',
        'mdi mdi-eye-lock-open-outline',
        'mdi mdi-eye-lock-outline',
        'mdi mdi-eye-minus',
        ...
        'mdi mdi-file-arrow-left-right',
        'mdi mdi-file-arrow-left-right-outline',
        'mdi mdi-file-arrow-up-down',
        'mdi mdi-file-arrow-up-down-outline',
        ...
        'mdi mdi-file-chart',
        'mdi mdi-file-chart-check',
        'mdi mdi-file-chart-check-outline',
        ...
        'mdi mdi-file-document-alert',
        'mdi mdi-file-document-alert-outline',
        'mdi mdi-file-document-arrow-right',
        'mdi mdi-file-document-arrow-right-outline',
        'mdi mdi-file-document-check',
        'mdi mdi-file-document-check-outline',
        'mdi mdi-file-document-edit',
        'mdi mdi-file-document-edit-outline',
        'mdi mdi-file-document-minus',
        'mdi mdi-file-document-minus-outline',
        'mdi mdi-file-document-multiple',
        'mdi mdi-file-document-multiple-outline',
        'mdi mdi-file-document-outline',
        'mdi mdi-file-document-plus',
        'mdi mdi-file-document-plus-outline',
        'mdi mdi-file-document-remove',
        'mdi mdi-file-document-remove-outline',
        ...
        'mdi mdi-file-lock',
        'mdi mdi-file-lock-open',
        'mdi mdi-file-lock-open-outline',
        'mdi mdi-file-lock-outline',
        'mdi mdi-file-marker',
        'mdi mdi-file-marker-outline',
        'mdi mdi-file-minus',
        'mdi mdi-file-minus-outline',
        'mdi mdi-file-move',
        ...
        'mdi mdi-file-rotate-left',
        'mdi mdi-file-rotate-left-outline',
        'mdi mdi-file-rotate-right',
        ...
        'mdi mdi-filter-cog',
        'mdi mdi-filter-cog-outline',
        'mdi mdi-filter-menu',
        'mdi mdi-filter-menu-outline',
        'mdi mdi-filter-minus',
        'mdi mdi-filter-minus-outline',
        'mdi mdi-filter-multiple',
        'mdi mdi-filter-multiple-outline',
        'mdi mdi-filter-off',
        ...
        'mdi mdi-filter-settings',
        'mdi mdi-filter-settings-outline',
        ...
        'mdi mdi-flag-variant-minus',
        'mdi mdi-flag-variant-minus-outline',
        'mdi mdi-flag-variant-off',
        'mdi mdi-flag-variant-off-outline',
        'mdi mdi-flag-variant-outline',
        'mdi mdi-flag-variant-plus',
        'mdi mdi-flag-variant-plus-outline',
        'mdi mdi-flag-variant-remove',
        'mdi mdi-flag-variant-remove-outline',
        'mdi mdi-flare',
        'mdi mdi-flash',
        'mdi mdi-flash-alert',
        ...
        'mdi mdi-flash-auto',
        'mdi mdi-flash-off',
        'mdi mdi-flash-off-outline',
        'mdi mdi-flash-outline',
        'mdi mdi-flash-red-eye',
        'mdi mdi-flash-triangle',
        'mdi mdi-flash-triangle-outline',
        'mdi mdi-flashlight',
        ...
        'mdi mdi-folder-arrow-down',
        'mdi mdi-folder-arrow-down-outline',
        'mdi mdi-folder-arrow-left',
        'mdi mdi-folder-arrow-left-outline',
        'mdi mdi-folder-arrow-left-right',
        'mdi mdi-folder-arrow-left-right-outline',
        'mdi mdi-folder-arrow-right',
        'mdi mdi-folder-arrow-right-outline',
        'mdi mdi-folder-arrow-up',
        'mdi mdi-folder-arrow-up-down',
        'mdi mdi-folder-arrow-up-down-outline',
        'mdi mdi-folder-arrow-up-outline',
        'mdi mdi-folder-cancel',
        'mdi mdi-folder-cancel-outline',
        ...
        'mdi mdi-folder-lock-open-outline',
        'mdi mdi-folder-lock-outline',
        'mdi mdi-folder-marker',
        'mdi mdi-folder-marker-outline',
        'mdi mdi-folder-minus',
        'mdi mdi-folder-minus-outline',
        'mdi mdi-folder-move',
        ...
        'mdi mdi-folder-wrench',
        'mdi mdi-folder-wrench-outline',
        'mdi mdi-folder-zip',
        ...
        'mdi mdi-format-constter-case',
        'mdi mdi-format-constter-case-lower',
        'mdi mdi-format-constter-case-upper',
        'mdi mdi-format-constter-ends-with',
        'mdi mdi-format-constter-matches',
        'mdi mdi-format-constter-spacing',
        'mdi mdi-format-constter-spacing-variant',
        'mdi mdi-format-constter-starts-with',
        'mdi mdi-format-line-height',
        'mdi mdi-format-line-spacing',
        'mdi mdi-format-line-style',
        'mdi mdi-format-line-weight',
        'mdi mdi-format-list-bulconsted',
        'mdi mdi-format-list-bulconsted-square',
        'mdi mdi-format-list-bulconsted-triangle',
        'mdi mdi-format-list-bulconsted-type',
        'mdi mdi-format-list-checkbox',
        'mdi mdi-format-list-checks',
        'mdi mdi-format-list-group',
        'mdi mdi-format-list-group-plus',
        ...
        'mdi mdi-format-paragraph-spacing',
        'mdi mdi-format-pilcrow',
        'mdi mdi-format-pilcrow-arrow-left',
        'mdi mdi-format-pilcrow-arrow-right',
        ...
        'mdi mdi-forum',
        'mdi mdi-forum-minus',
        'mdi mdi-forum-minus-outline',
        'mdi mdi-forum-outline',
        'mdi mdi-forum-plus',
        'mdi mdi-forum-plus-outline',
        'mdi mdi-forum-remove',
        'mdi mdi-forum-remove-outline',
        'mdi mdi-forward',
        ...
        'mdi mdi-fridge-industrial-alert-outline',
        ...
        'mdi mdi-fridge-variant-alert-outline',
        ...
        'mdi mdi-heat-pump',
        'mdi mdi-heat-pump-outline',
        'mdi mdi-heat-wave',
        'mdi mdi-heating-coil',
        'mdi mdi-helicopter',
        'mdi mdi-help',
        'mdi mdi-help-box',
        'mdi mdi-help-box-multiple',
        'mdi mdi-help-box-multiple-outline',
        'mdi mdi-help-box-outline',
        'mdi mdi-help-circle',
        ...
        'mdi mdi-image-filter-drama-outline',
        ...
        'mdi mdi-image-frame',
        'mdi mdi-image-lock',
        'mdi mdi-image-lock-outline',
        'mdi mdi-image-marker',
        'mdi mdi-image-marker-outline',
        'mdi mdi-image-minus',
        'mdi mdi-image-minus-outline',
        'mdi mdi-image-move',
        ...
        'mdi mdi-image-plus',
        'mdi mdi-image-plus-outline',
        'mdi mdi-image-refresh',
        'mdi mdi-image-refresh-outline',
        'mdi mdi-image-remove',
        'mdi mdi-image-remove-outline',
        ...
        'mdi mdi-keyboard-close-outline',
        ...
        'mdi mdi-land-fields',
        'mdi mdi-land-plots',
        'mdi mdi-land-plots-circle',
        'mdi mdi-land-plots-circle-variant',
        'mdi mdi-land-rows-horizontal',
        'mdi mdi-land-rows-vertical',
        'mdi mdi-landslide',
        'mdi mdi-landslide-outline',
        'mdi mdi-language-c',
        ...
        'mdi mdi-light-switch-off',
        'mdi mdi-lightbulb',
        'mdi mdi-lightbulb-alert',
        'mdi mdi-lightbulb-alert-outline',
        ...
        'mdi mdi-lightbulb-night',
        'mdi mdi-lightbulb-night-outline',
        'mdi mdi-lightbulb-off',
        'mdi mdi-lightbulb-off-outline',
        'mdi mdi-lightbulb-on',
        'mdi mdi-lightbulb-on-10',
        'mdi mdi-lightbulb-on-20',
        'mdi mdi-lightbulb-on-30',
        'mdi mdi-lightbulb-on-40',
        'mdi mdi-lightbulb-on-50',
        'mdi mdi-lightbulb-on-60',
        'mdi mdi-lightbulb-on-70',
        'mdi mdi-lightbulb-on-80',
        'mdi mdi-lightbulb-on-90',
        'mdi mdi-lightbulb-on-outline',
        'mdi mdi-lightbulb-outline',
        'mdi mdi-lightbulb-question',
        'mdi mdi-lightbulb-question-outline',
        ...
        'mdi mdi-lock-percent',
        'mdi mdi-lock-percent-open',
        'mdi mdi-lock-percent-open-outline',
        'mdi mdi-lock-percent-open-variant',
        'mdi mdi-lock-percent-open-variant-outline',
        'mdi mdi-lock-percent-outline',
        'mdi mdi-lock-plus',
        ...
        'mdi mdi-medical-bag',
        'mdi mdi-medical-cotton-swab',
        'mdi mdi-medication',
        'mdi mdi-medication-outline',
        'mdi mdi-meditation',
        'mdi mdi-memory',
        'mdi mdi-menorah',
        ...
        'mdi mdi-message-bulconsted',
        'mdi mdi-message-bulconsted-off',
        'mdi mdi-message-check',
        'mdi mdi-message-check-outline',
        'mdi mdi-message-cog',
        'mdi mdi-message-cog-outline',
        'mdi mdi-message-draw',
        'mdi mdi-message-fast',
        'mdi mdi-message-fast-outline',
        ...
        'mdi mdi-message-text-fast',
        'mdi mdi-message-text-fast-outline',
        'mdi mdi-message-text-lock',
        'mdi mdi-message-text-lock-outline',
        'mdi mdi-message-text-outline',
        'mdi mdi-message-video',
        'mdi mdi-meteor',
        'mdi mdi-meter-electric',
        'mdi mdi-meter-electric-outline',
        'mdi mdi-meter-gas',
        'mdi mdi-meter-gas-outline',
        'mdi mdi-metronome',
        'mdi mdi-metronome-tick',
        'mdi mdi-micro-sd',
        'mdi mdi-microphone',
        'mdi mdi-microphone-message',
        'mdi mdi-microphone-message-off',
        ...
        'mdi mdi-monitor',
        'mdi mdi-monitor-account',
        'mdi mdi-monitor-arrow-down',
        'mdi mdi-monitor-arrow-down-variant',
        ...
        'mdi mdi-notebook-heart',
        'mdi mdi-notebook-heart-outline',
        ...
        'mdi mdi-office-building-minus',
        'mdi mdi-office-building-minus-outline',
        'mdi mdi-office-building-outline',
        'mdi mdi-office-building-plus',
        'mdi mdi-office-building-plus-outline',
        'mdi mdi-office-building-remove',
        'mdi mdi-office-building-remove-outline',
        'mdi mdi-oil',
        'mdi mdi-oil-lamp',
        'mdi mdi-oil-level',
        ...
        'mdi mdi-package-variant-closed-minus',
        'mdi mdi-package-variant-closed-plus',
        'mdi mdi-package-variant-closed-remove',
        'mdi mdi-package-variant-minus',
        'mdi mdi-package-variant-plus',
        'mdi mdi-package-variant-remove',
        'mdi mdi-page-first',
        'mdi mdi-page-last',
        ...
        'mdi mdi-paconstte',
        'mdi mdi-paconstte-advanced',
        'mdi mdi-paconstte-outline',
        'mdi mdi-paconstte-swatch',
        'mdi mdi-paconstte-swatch-outline',
        'mdi mdi-paconstte-swatch-variant',
        'mdi mdi-palm-tree',
        'mdi mdi-pan',
        ...
        'mdi mdi-paperclip',
        'mdi mdi-paperclip-check',
        'mdi mdi-paperclip-lock',
        'mdi mdi-paperclip-minus',
        'mdi mdi-paperclip-off',
        'mdi mdi-paperclip-plus',
        'mdi mdi-paperclip-remove',
        'mdi mdi-parachute',
        ...
        'mdi mdi-percent',
        'mdi mdi-percent-box',
        'mdi mdi-percent-box-outline',
        'mdi mdi-percent-circle',
        'mdi mdi-percent-circle-outline',
        ...
        'mdi mdi-phone-incoming-outgoing',
        'mdi mdi-phone-incoming-outgoing-outline',
        ...
        'mdi mdi-play',
        'mdi mdi-play-box',
        'mdi mdi-play-box-lock',
        'mdi mdi-play-box-lock-open',
        'mdi mdi-play-box-lock-open-outline',
        'mdi mdi-play-box-lock-outline',
        ...
        'mdi mdi-printer-3d-nozzle-off',
        'mdi mdi-printer-3d-nozzle-off-outline',
        'mdi mdi-printer-3d-nozzle-outline',
        'mdi mdi-printer-3d-off',
        ...
        'mdi mdi-printer-pos',
        'mdi mdi-printer-pos-alert',
        'mdi mdi-printer-pos-alert-outline',
        'mdi mdi-printer-pos-cancel',
        'mdi mdi-printer-pos-cancel-outline',
        'mdi mdi-printer-pos-check',
        'mdi mdi-printer-pos-check-outline',
        'mdi mdi-printer-pos-cog',
        'mdi mdi-printer-pos-cog-outline',
        'mdi mdi-printer-pos-edit',
        'mdi mdi-printer-pos-edit-outline',
        'mdi mdi-printer-pos-minus',
        'mdi mdi-printer-pos-minus-outline',
        'mdi mdi-printer-pos-network',
        'mdi mdi-printer-pos-network-outline',
        'mdi mdi-printer-pos-off',
        'mdi mdi-printer-pos-off-outline',
        'mdi mdi-printer-pos-outline',
        'mdi mdi-printer-pos-pause',
        'mdi mdi-printer-pos-pause-outline',
        'mdi mdi-printer-pos-play',
        'mdi mdi-printer-pos-play-outline',
        'mdi mdi-printer-pos-plus',
        'mdi mdi-printer-pos-plus-outline',
        'mdi mdi-printer-pos-refresh',
        'mdi mdi-printer-pos-refresh-outline',
        'mdi mdi-printer-pos-remove',
        'mdi mdi-printer-pos-remove-outline',
        'mdi mdi-printer-pos-star',
        'mdi mdi-printer-pos-star-outline',
        'mdi mdi-printer-pos-stop',
        'mdi mdi-printer-pos-stop-outline',
        'mdi mdi-printer-pos-sync',
        'mdi mdi-printer-pos-sync-outline',
        'mdi mdi-printer-pos-wrench',
        'mdi mdi-printer-pos-wrench-outline',
        ...
        'mdi mdi-quora',
        'mdi mdi-rabbit',
        'mdi mdi-rabbit-variant',
        'mdi mdi-rabbit-variant-outline',
        ...
        'mdi mdi-read',
        'mdi mdi-receipt',
        'mdi mdi-receipt-outline',
        'mdi mdi-receipt-text',
        'mdi mdi-receipt-text-check',
        'mdi mdi-receipt-text-check-outline',
        'mdi mdi-receipt-text-minus',
        'mdi mdi-receipt-text-minus-outline',
        'mdi mdi-receipt-text-outline',
        'mdi mdi-receipt-text-plus',
        'mdi mdi-receipt-text-plus-outline',
        'mdi mdi-receipt-text-remove',
        'mdi mdi-receipt-text-remove-outline',
        'mdi mdi-record',
        ...
        'mdi mdi-rename',
        'mdi mdi-rename-box',
        'mdi mdi-rename-box-outline',
        'mdi mdi-rename-outline',
        ...
        'mdi mdi-robot-industrial-outline',
        'mdi mdi-robot-love',
        ...
        'mdi mdi-robot-vacuum-alert',
        'mdi mdi-robot-vacuum-off',
        'mdi mdi-robot-vacuum-variant',
        'mdi mdi-robot-vacuum-variant-alert',
        'mdi mdi-robot-vacuum-variant-off',
        'mdi mdi-rocket',
        'mdi mdi-rocket-launch',
        'mdi mdi-rocket-launch-outline',
        'mdi mdi-rocket-outline',
        'mdi mdi-rodent',
        'mdi mdi-roller-shade',
        'mdi mdi-roller-shade-closed',
        ...
        'mdi mdi-seed-plus',
        'mdi mdi-seed-plus-outline',
        'mdi mdi-seesaw',
        'mdi mdi-segment',
        'mdi mdi-select',
        'mdi mdi-select-all',
        'mdi mdi-select-arrow-down',
        'mdi mdi-select-arrow-up',
        ...
        'mdi mdi-shimmer',
        'mdi mdi-ship-wheel',
        'mdi mdi-shipping-palconst',
        'mdi mdi-shoe-balconst',
        'mdi mdi-shoe-cleat',
        'mdi mdi-shoe-formal',
        'mdi mdi-shoe-heel',
        'mdi mdi-shoe-print',
        ...
        'mdi mdi-shopping-search-outline',
        'mdi mdi-shore',
        'mdi mdi-shovel',
        'mdi mdi-shovel-off',
        'mdi mdi-shower',
        ...
        'mdi mdi-sign-language',
        'mdi mdi-sign-language-outline',
        'mdi mdi-sign-pole',
        ...
        'mdi mdi-smoke-detector-alert-outline',
        ...
        'mdi mdi-snowflake-check',
        'mdi mdi-snowflake-melt',
        'mdi mdi-snowflake-off',
        'mdi mdi-snowflake-thermometer',
        ...
        'mdi mdi-solar-power',
        'mdi mdi-solar-power-variant',
        'mdi mdi-solar-power-variant-outline',
        ...
        'mdi mdi-speaker-message',
        'mdi mdi-speaker-multiple',
        'mdi mdi-speaker-off',
        'mdi mdi-speaker-pause',
        'mdi mdi-speaker-play',
        'mdi mdi-speaker-stop',
        ...
        'mdi mdi-square-rounded-badge',
        'mdi mdi-square-rounded-badge-outline',
        ...
        'mdi mdi-storage-tank',
        'mdi mdi-storage-tank-outline',
        'mdi mdi-store',
        'mdi mdi-store-24-hour',
        'mdi mdi-store-alert',
        'mdi mdi-store-alert-outline',
        'mdi mdi-store-check',
        ...
        'mdi mdi-storefront',
        'mdi mdi-storefront-check',
        'mdi mdi-storefront-check-outline',
        'mdi mdi-storefront-edit',
        'mdi mdi-storefront-edit-outline',
        'mdi mdi-storefront-minus',
        'mdi mdi-storefront-minus-outline',
        'mdi mdi-storefront-outline',
        'mdi mdi-storefront-plus',
        'mdi mdi-storefront-plus-outline',
        'mdi mdi-storefront-remove',
        'mdi mdi-storefront-remove-outline',
        'mdi mdi-stove',
        'mdi mdi-strategy',
        ...
        'mdi mdi-summit',
        'mdi mdi-sun-angle',
        'mdi mdi-sun-angle-outline',
        'mdi mdi-sun-clock',
        'mdi mdi-sun-clock-outline',
        'mdi mdi-sun-compass',
        'mdi mdi-sun-snowflake',
        'mdi mdi-sun-snowflake-variant',
        ...
        'mdi mdi-tabconst',
        'mdi mdi-tabconst-cellphone',
        'mdi mdi-tabconst-dashboard',
        'mdi mdi-taco',
        'mdi mdi-tag',
        ...
        'mdi mdi-tailwind',
        'mdi mdi-tally-mark-1',
        'mdi mdi-tally-mark-2',
        'mdi mdi-tally-mark-3',
        'mdi mdi-tally-mark-4',
        'mdi mdi-tally-mark-5',
        'mdi mdi-tangram',
        'mdi mdi-tank',
        ...
        'mdi mdi-television-speaker',
        'mdi mdi-television-speaker-off',
        'mdi mdi-television-stop',
        'mdi mdi-temperature-celsius',
        'mdi mdi-temperature-fahrenheit',
        'mdi mdi-temperature-kelvin',
        'mdi mdi-temple-buddhist',
        'mdi mdi-temple-buddhist-outline',
        'mdi mdi-temple-hindu',
        'mdi mdi-temple-hindu-outline',
        'mdi mdi-tennis',
        'mdi mdi-tennis-ball',
        'mdi mdi-tent',
        'mdi mdi-terraform',
        ...
        'mdi mdi-thermometer-auto',
        'mdi mdi-thermometer-bluetooth',
        'mdi mdi-thermometer-check',
        ...
        'mdi mdi-thermometer-probe',
        'mdi mdi-thermometer-probe-off',
        'mdi mdi-thermometer-water',
        'mdi mdi-thermostat',
        'mdi mdi-thermostat-auto',
        'mdi mdi-thermostat-box',
        'mdi mdi-thermostat-box-auto',
        ...
        'mdi mdi-timeline-question',
        'mdi mdi-timeline-question-outline',
        ...
        'mdi mdi-timer-3',
        'mdi mdi-timer-alert',
        'mdi mdi-timer-alert-outline',
        'mdi mdi-timer-cancel',
        'mdi mdi-timer-cancel-outline',
        'mdi mdi-timer-check',
        'mdi mdi-timer-check-outline',
        'mdi mdi-timer-cog',
        'mdi mdi-timer-cog-outline',
        'mdi mdi-timer-edit',
        'mdi mdi-timer-edit-outline',
        'mdi mdi-timer-lock',
        'mdi mdi-timer-lock-open',
        'mdi mdi-timer-lock-open-outline',
        'mdi mdi-timer-lock-outline',
        'mdi mdi-timer-marker',
        'mdi mdi-timer-marker-outline',
        'mdi mdi-timer-minus',
        'mdi mdi-timer-minus-outline',
        'mdi mdi-timer-music',
        'mdi mdi-timer-music-outline',
        'mdi mdi-timer-off',
        'mdi mdi-timer-off-outline',
        'mdi mdi-timer-outline',
        'mdi mdi-timer-pause',
        'mdi mdi-timer-pause-outline',
        'mdi mdi-timer-play',
        'mdi mdi-timer-play-outline',
        'mdi mdi-timer-plus',
        'mdi mdi-timer-plus-outline',
        'mdi mdi-timer-refresh',
        'mdi mdi-timer-refresh-outline',
        'mdi mdi-timer-remove',
        'mdi mdi-timer-remove-outline',
        'mdi mdi-timer-sand',
        'mdi mdi-timer-sand-compconste',
        ...
        'mdi mdi-timer-star',
        'mdi mdi-timer-star-outline',
        'mdi mdi-timer-stop',
        'mdi mdi-timer-stop-outline',
        'mdi mdi-timer-sync',
        'mdi mdi-timer-sync-outline',
        'mdi mdi-timetable',
        'mdi mdi-tire',
        'mdi mdi-toaster',
        'mdi mdi-toaster-off',
        ...
        'mdi mdi-toggle-switch-variant',
        'mdi mdi-toggle-switch-variant-off',
        'mdi mdi-toiconst',
        'mdi mdi-toolbox',
        ...
        'mdi mdi-tooltip-question',
        'mdi mdi-tooltip-question-outline',
        ...
        'mdi mdi-train',
        'mdi mdi-train-car',
        'mdi mdi-train-car-autorack',
        'mdi mdi-train-car-box',
        'mdi mdi-train-car-box-full',
        'mdi mdi-train-car-box-open',
        'mdi mdi-train-car-caboose',
        'mdi mdi-train-car-centerbeam',
        'mdi mdi-train-car-centerbeam-full',
        'mdi mdi-train-car-container',
        'mdi mdi-train-car-flatbed',
        'mdi mdi-train-car-flatbed-car',
        'mdi mdi-train-car-flatbed-tank',
        'mdi mdi-train-car-gondola',
        'mdi mdi-train-car-gondola-full',
        'mdi mdi-train-car-hopper',
        'mdi mdi-train-car-hopper-covered',
        'mdi mdi-train-car-hopper-full',
        'mdi mdi-train-car-intermodal',
        ...
        'mdi mdi-triangle-small-down',
        'mdi mdi-triangle-small-up',
        ...
        'mdi mdi-vector-point-edit',
        'mdi mdi-vector-point-minus',
        'mdi mdi-vector-point-plus',
        'mdi mdi-vector-point-select',
        ...
        'mdi mdi-voicemail',
        'mdi mdi-volcano',
        'mdi mdi-volcano-outline',
        'mdi mdi-volleyball',
        'mdi mdi-volume-equal',
        'mdi mdi-volume-high',
        'mdi mdi-volume-low',
        ...
        'mdi mdi-walconst',
        'mdi mdi-walconst-giftcard',
        'mdi mdi-walconst-membership',
        'mdi mdi-walconst-outline',
        'mdi mdi-walconst-plus',
        'mdi mdi-walconst-plus-outline',
        'mdi mdi-walconst-travel',
        'mdi mdi-wallpaper',
        'mdi mdi-wan',
        'mdi mdi-wardrobe',
        ...
        'mdi mdi-water-sync',
        'mdi mdi-water-thermometer',
        'mdi mdi-water-thermometer-outline',
        'mdi mdi-water-well',
        ...
        'mdi mdi-window-shutter-auto',
        'mdi mdi-window-shutter-cog',
        'mdi mdi-window-shutter-open',
        'mdi mdi-window-shutter-settings',
        'mdi mdi-windsock',
        'mdi mdi-wiper',
        'mdi mdi-wiper-wash',
        ...
        'mdi mdi-wrench',
        'mdi mdi-wrench-check',
        'mdi mdi-wrench-check-outline',
        'mdi mdi-wrench-clock',
        'mdi mdi-wrench-clock-outline',
        'mdi mdi-wrench-cog',
    ...
    const initIconsField = () => {
        $('.icon-select').each((index, el) => {
            const value = $(el).children('option:selected').val()

            let options

            if (!value) {
                options = `<option value="">&nbsp</option>'`
            }
    ...
    document.addEventListener('core-init-resources', () => {
        initIconsField()
    })
})
